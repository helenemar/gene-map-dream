  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <Helmet>
        ...
        <meta name="description" content="Conditions Générales d'Utilisation de Genogy : accès au service, comptes utilisateurs, propriété intellectuelle et responsabilités." />
        <meta name="robots" content="index,follow" />
        <meta property="og:title" content="Conditions Générales d'Utilisation — Genogy" />
        <meta property="og:description" content="CGU de Genogy : accès, comptes, propriété intellectuelle et responsabilités." />
        <meta property="og:url" content="https://www.genogy-app.com/terms" />
        <meta property="og:image" content="https://www.genogy-app.com/og-image.webp" />
      </Helmet>
      <SeoLinks pageKey="terms" locale="fr" />
