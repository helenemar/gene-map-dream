...
const GenogramEditor: React.FC<GenogramEditorProps> = ({ shareToken, sharedInitialData }) => {
  ...
  // Auto-layout removed — members are placed at viewport center, user drags them manually.
  // The "Réorganiser" button (handleAutoLayout) is still available for manual re-layout.
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <svg className="absolute pointer-events-none" style={{ zIndex: 50, overflow: 'visible', top: 0, left: 0, width: 1, height: 1, opacity: presentationMode ? 1 : (search.isActive && search.matchedEmotionalLinkIds.size === 0) ? 0.7 : 1, transition: 'opacity 0.3s' }}>
