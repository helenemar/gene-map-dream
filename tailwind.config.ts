    ...
    extend: {
      ...
      colors: {
        ...
        pathology: {
          ...
          addiction: "hsl(var(--pathology-addiction))",
          bipolar: "hsl(var(--pathology-bipolar))",
          cardiovascular: "hsl(var(--pathology-cardiovascular))",
          diabetes: "hsl(var(--pathology-diabetes))",
      ...
      animation: {
        ...
        "snap-haptic": "snap-haptic 0.25s ease-out",
      },
    },
  },
